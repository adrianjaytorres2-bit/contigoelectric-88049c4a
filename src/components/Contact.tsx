        ...
        <div className="grid lg:grid-cols-3 gap-6 md:gap-8">
          ...
          >
            {contactInfo.map((info) => (
              <div key={info.label} className="flex items-center lg:items-start gap-3 md:gap-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
                  ...
                  <div>
                    ...
                    <Textarea
                      ...
                      className="bg-secondary border-border min-h-[100px] md:min-h-[120px] text-sm md:text-base"
                  ...
                  <Button
                    ...
                    className="w-full bg-primary text-primary-foreground hover:bg-primary/90 font-display text-base md:text-lg tracking-wider py-2.5 md:py-3"
                  >
